<template>
  <div>
   <button @click="isActive = !isActive" class="block sm:inline-block  rounded text-gray-200 font-semibold hover:bg-gray-200 hover:text-primary px-4 py-2 text-left  w-full focus:outline-none">
