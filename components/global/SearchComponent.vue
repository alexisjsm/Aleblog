<template>
  <div>
   <button @click="isActive = !isActive" class="block sm:inline-block  rounded text-white font-semibold hover:bg-teal-500 hover:text-gray-100 px-4 py-2 text-left  w-full focus:outline-none">
...
<transition name="fade-in">
  <div :class="isActive ? 'block' : 'hidden'" class="z-50 fixed left-0 top-0 lg:w-screen lg:h-screen w-full h-full p-16 overflow-auto bg-gray-800 bg-opacity-50 lg:p-64">
      <div class="flex flex-col justify-center bg-gray-400 px-4 py-2 rounded-lg mx-auto lg:w-1/2">
